...
/*Project class it handles startup initilization and user input handling 
...
public class Project {
	...
	*/
	...
	/*	
	main user input handling checks how much was inserted and
	...
	*/
	...
	if (amount == 10) {
	    ...
	    System.out.println("Not valid ammount inserted"); // for cases where user inputs a string or large/negative numbers
	}
