	...
	*/
	...
	spin10.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
		    ...
		    wheel1prev.setIcon(new ImageIcon(results[1]));
		    wheel1.setIcon(new ImageIcon(results[2]));
		    wheel1next.setIcon(new ImageIcon(results[3]));
		    wheel2prev.setIcon(new ImageIcon(results[4]));
		    wheel2.setIcon(new ImageIcon(results[5]));
		    wheel2next.setIcon(new ImageIcon(results[6]));
		    wheel3prev.setIcon(new ImageIcon(results[7]));
		    wheel3.setIcon(new ImageIcon(results[8]));
		    wheel3next.setIcon(new ImageIcon(results[9]));
